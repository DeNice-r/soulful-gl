...
import { XForm } from '~/components/management/QnA/XForm';
import { AmountSelect } from '~/components/management/common/AmountSelect';

const TableHeaders: Record<string, string> = {
    [SortableQnAFields.ID]: 'Ідентифікатор',
    [SortableQnAFields.QUESTION]: 'Питання',
    [SortableQnAFields.ANSWER]: 'Відповідь',
    [SortableQnAFields.AUTHOR_EMAIL]: 'Email автора',
    [SortableQnAFields.AUTHOR_NAME]: "Ім'я автора",
    [SortableQnAFields.CREATED_AT]: 'Дата створення',
    [SortableQnAFields.UPDATED_AT]: 'Дата оновлення',
    [SortableQnAFields.PUBLISHED]: 'Статус',
} as const;
...
const XTable: React.FC = () => {
    ...
    const entities = api.qanda.list.useQuery(
    ...
    const [editable, setEditable] = useState<RouterOutputs['qanda']['get']>();

    const editHandler = async (arg: number) => {
        setEditable(await apiClient.qanda.get.query(arg));
        changeModalState();
    };
    ...
    return (
        <>
            <div className="flex w-full justify-between">
                <div className="flex gap-5">
                    <div className="relative min-w-96">
                        ...
                        <Input
                            ...
                            placeholder="Шукати питання та відповіді"
                            defaultValue={query}
                            onChange={(e) =>
                ...
                <Button onClick={createHandler}>Нове питання</Button>
                <Modal
                    isOpen={isModalOpen}
