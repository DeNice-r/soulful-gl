...
const SvgIcon = {
    ...
    [ManagementPageName.RECOMMENDATIONS]:
...
export const Sidebar: React.FC<Props & { entity: ManagementPageName }> = ({
    ...
    for (const page of Object.values(ManagementPageName)) {
        ...
        hasAccess(
            ...
            PermissionEntity[page],
            PermissionAction[page],
        ) &&
            links.push(
                entity !== page ? (
                    <Link
