...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={cn(
            'h-12 select-none px-4 text-left align-middle font-medium text-neutral-500 hover:cursor-pointer hover:text-black dark:text-neutral-400 [&:has([role=checkbox])]:pr-0',
            className,
        )}
        {...props}
    />
